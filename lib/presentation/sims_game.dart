...
class SimsGame extends FlameGame with HasKeyboardHandlerComponents {
  ...
  Future<void> onLoad() async {
    ...
    debugPrint('SimsGame initialized with 15Hz simulation clock and event bus!');
    ...
    if (event is KeyDownEvent) {
      switch (event.logicalKey) {
        case LogicalKeyboardKey.f1:
          ...
          _eventBus.publish(DebugOverlayToggledEvent(
        ...
        case LogicalKeyboardKey.space:
          ...
          if (wasPaused) {
            _eventBus.publish(SimulationResumedEvent(timestamp: DateTime.now()));
          } else {
        ...
        case LogicalKeyboardKey.numpadAdd:
          ...
          _eventBus.publish(SimulationSpeedChangedEvent(
            oldSpeed: oldSpeed,
