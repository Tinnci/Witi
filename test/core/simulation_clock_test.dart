...
void main() {
  group('SimulationClock', () {
    ...
    test('should have correct constants', () {
      expect(SimulationClock.ticksPerSecond, equals(15));
      expect(
        SimulationClock.tickDuration,
        equals(const Duration(milliseconds: 67)),
      );
    });
    ...
    test('should start and emit tick events', () async {
      ...
      expect(firstTick.deltaTime, equals(SimulationClock.tickDuration));
